...
broom::tidy(project_lm) |>
  ...
  scales::label_pvalue(accuracy = 0.0001,
                       decimal.mark = ".",
                       prefix = "<")
```
